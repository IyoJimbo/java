    	...
    	<div class="zc">
            ...
            <h3>欢迎注册</h3>
                ...
                <input name="username" type="text" class="kuang_txt phone" placeholder="用户名">
                  ...
                  <input name="ruserPassword" type="password" class="kuang_txt possword" placeholder="密码">
                ...
                <input name="submit" type="submit" class="btn_zhuce" value="注册">
                </form>
            </div>
        	<div class="bj_right">
            	<p>已有账号，直接登录</p>
                <div>
                    <img src="images/logo-ecjtu.png" style="height: 150px;width:150px; margin-top: 80px;">
                </div>
